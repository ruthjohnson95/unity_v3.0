...
GWAS_DIR=/u/flashscratch/r/ruthjohn/ukbb_bmi_exp/gwas
...
SCRIPT_DIR=/u/flashscratch/r/ruthjohn/ukbb_bmi_exp/scripts
SRC_DIR=/u/flashscratch/r/ruthjohn/ukbb_bmi_exp/src
SIM_NAME=${PREFIX}
N=337205
...
OUTDIR=/u/flashscratch/r/ruthjohn/ukbb_bmi_exp/results_chr
mkdir -p $OUTDIR
